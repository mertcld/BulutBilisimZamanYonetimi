...
$(document).ready(function () {
  ...
  var kanban_board_data = [{
      ...
      item: [{
        ...
        {
          id: "15",
          title: "Ödeme Yapılacak",
            border: "secondary",
            image: "../images/odeme.jpeg",
        }
      ]
    },
    
    {
      ...
      item: [{
          id: "31",
          title: "Modeller ve tablolar oluşturulacak.",
          border: "warning",
          dueDate: "--",
          comment: 10,
          users: [
        ...
        {
          id: "32",
          title: "Controller ve Viewsler oluşturulacak🙂",
          border: "success",
          dueDate: "--",
          comment: 7,
          badgeContent: "MB",
        ...
        {
          id: "33",
          title: "POST Methodları yazılacak",
          border: "primary",
          dueDate: "--",
          users: [
            "../../../app-assets/images/portrait/small/avatar-s-1.png",
  ...
  var KanbanExample = new jKanban({
    ...
    buttonContent: "+ Yeni Ekle", // text or html content of the board button
    ...
    buttonClick: function (el, boardId) {
      ...
      formItem.innerHTML =
        ...
        "</div>" +
        '<div class="form-group">' +
        '<button type="submit" class="btn btn-primary btn-sm mr-50">Ekle</button>' +
        '<button type="button" id="CancelBtn" class="btn btn-sm btn-danger">İptal</button>' +
        "</div>";
  ...
  addBoardDefault.addEventListener("click", function () {
    ...
    if (kanbanNewBoard) {
      ...
      kanbanNewBoardData =
        ...
        '<a class="dropdown-item" href="#"><i class="feather icon-link mr-50"></i>Kopyala</a>' +
        '<a class="dropdown-item kanban-delete" id="kanban-delete" href="#"><i class="feather icon-trash-2 mr-50"></i>Sil</a>' +
        "</div>" + "</div>";
