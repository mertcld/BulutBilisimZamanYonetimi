...
$(function () {
  ...
  $('.add-task-btn').on('click', function () {
    ...
    taskDescription.removeClass("d-none");
  ...
  todoTaskListWrapper.on('click', '.todo-item', function (e) {
    ...
    var todoDescription = $this.find(".todo-description").text();
      todoDescription.val(todoDescription);
    var compose_editor = $(".compose-editor .ql-editor");
    compose_editor[0].innerHTML = todoTitle;
    compose_editor[3].innerHTML = todoDescription;
